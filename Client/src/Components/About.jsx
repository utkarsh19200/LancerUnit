      ...
      <Wrapper>
        <main>
          ...
          <div className="container">
            ...
            >
              <div className="img">
                <img src="https://ik.imagekit.io/lancer11776/Lancer.Units/lancer2.jpg?updatedAt=1682608749618" alt="" loading="lazy"/>
              </div>
              <div className="info">
                <h3>lancer2 a</h3>
            ...
            >
              <div className="img">
                <img src="https://ik.imagekit.io/lancer11776/Lancer.Units/lancer1.jpg?updatedAt=1682608756655" alt="" loading="lazy" />
              </div>
              <div className="info">
                <h3>lancer1 b</h3>
              ...
              <ul className="social">
                <li>
                  <a
                    href="https://github.com/lancer11776"
                ...
                <li>
                  <a
                    href="https://twitter.com/blancer1"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/lancer1-b-94a24a21a/"
            ...
            >
              <div className="img">
                <img src="https://ik.imagekit.io/lancer11776/Lancer.Units/lancer3.jpg?updatedAt=1682608753482" alt="" loading="lazy"/>
              </div>
              <div className="info">
                <h3>lancer3 c</h3>
